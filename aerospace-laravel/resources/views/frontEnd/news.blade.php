...
<article class="post-14 page type-page status-publish has-post-thumbnail hentry" itemscope="" itemtype="http://schema.org/Article">
    <main role="main" class="main">
       <section class="page-title-block">
          <picture>
             <source media="(max-width: 575px)" srcset="https://tjaerospace.com/wp-content/uploads/2019/07/gear-400x720.jpg">
             <img alt="News" class="cover" src="https://tjaerospace.com/wp-content/uploads/2019/07/gear-1920x800.jpg" height="auto" width="auto">
          </picture>
             ...
             <div class="row">
                ...
                <article itemscope="" itemtype="http://schema.org/ItemPage" class="mb-4 col-12">
                  <div class="card card-news flex-md-row">
                     <a title="TJ Aerospace Continues Working On Its CNC Manufacturing Facility In Vietnam" href="{{url('/post-detail',$post->id)}}">
                     <img width="600" height="400" src="{{url('images/',$post->img)}}" alt="">        </a>
                     <div class="card-body d-flex flex-column align-items-start">
                        <div class="card-text">
                           <div class="date"><i class="fa fa-clock-o"></i> <time datetime="2019-07-08" itemprop="datePublished">July 8, 2019</time></div>
                        <h4 class="h5 font-weight-bold"><a href="https://tjaerospace.com/news/tj-aerospace-continues-working-on-its-cnc-manufacturing-facility-in-vietnam/">{{$post->title}}</a></h4>
                        </div>
