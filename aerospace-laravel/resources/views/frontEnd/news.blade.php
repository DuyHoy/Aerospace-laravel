       ...
       <section class="page-title-block">
          ...
          <div class="title-container">
             <div class="container">
                <div class="row">
                   <div class="col-md-6">
                      <h1 class="page-title">{{trans('news.title1')}}</h1>
                      <div class="lead">{{trans('news.title1-c1')}}</div>
                   </div>
                </div>
             </div>
          </div>
             ...
             <article itemscope="" itemtype="http://schema.org/ItemPage" class="col-md-6 mb-4 mb-md-5 col-news-featured">
                   <div class="card card-news card-news-featured">
                      ...
                      <div class="card-body">
                         ...
                         <h4 class="h5 font-weight-bold"><a href="https://tjaerospace.com/news/tj-aerospace-updates-its-website/">{{trans('news.title2-c2')}}</a></h4>
                      </div>
                      <div class="card-footer">
                         <a title="TJ Aerospace Updates Its Website" class="read-more" href="https://tjaerospace.com/news/tj-aerospace-updates-its-website/"><span>{{trans('news.title3')}}</span> <i class="fa fa-angle-right"></i></a>
                      </div>
                   </div>
                </article>
                <article itemscope="" itemtype="http://schema.org/ItemPage" class="col-md-6 mb-4 mb-md-5 col-news-featured">
                   <div class="card card-news card-news-featured">
                      ...
                      <div class="card-body">
                         ...
                         <h4 class="h5 font-weight-bold"><a href="https://tjaerospace.com/news/tj-aerospace-begins-installation-of-their-two-new-swiss-turn-machines-and-bar-feeders/">{{trans('news.title2-c3')}}</a></h4>
                      </div>
                      <div class="card-footer">
                         <a title="TJ Aerospace Begins Installation of Their Two New Swiss Turn Machines and Bar Feeders" class="read-more" href="https://tjaerospace.com/news/tj-aerospace-begins-installation-of-their-two-new-swiss-turn-machines-and-bar-feeders/"><span>{{trans('news.title3')}}</span> <i class="fa fa-angle-right"></i></a>
                      </div>
                   </div>
                </article>
             @foreach($posts as $post)
                <article itemscope="" itemtype="http://schema.org/ItemPage" class="mb-4 col-12">
                   ...
                   <a title={{$post->title}} href="/news/{{$post->id}}">
                      <img width="600" height="400" src="{{url('images',$post->img)}}" class="card-img-left flex-auto wp-post-image" alt="">        </a>
               ...
               @endforeach
                <nav class="nav flex-row pagination"><span aria-current="page" class="page-numbers current"><span class="sr-only">Page:  </span>1</span>
                   <a class="page-numbers" href="{{url('/post-detail',$post->id)}}"><span class="sr-only">Page:  </span>2</a>
