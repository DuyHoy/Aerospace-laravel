...
<article class="post-10 page type-page status-publish has-post-thumbnail hentry" itemscope="" itemtype="http://schema.org/Article">
    <main role="main" class="main">
       <section class="page-title-block">
          <picture>
             <source media="(max-width: 575px)" srcset="https://tjaerospace.com/wp-content/uploads/2019/07/machine-floor-400x720.jpg">
                   ...
                   <div class="col-lg-4 bg-gray py-5 py-md-6">
                      <div class="px-0 px-sm-4 px-xl-5">
                         ...
                         <div class="row mb-5">
                            ...
                            <div class="col-md-6 col-lg-12 col-xl-6 col-value">
                               <p>5WGW6</p>
                            </div>
                         ...
                         <div>
                            <p>Alloys, Aluminum, Brass, Bronze Alloys, Carbon Steel, Copper, Foam, Honeycomb Panels, Inconel, Iron, Phenolic, Plastic, Plates, Stainless Steel, Titanium, Exotic Materials, Etc.</p>
                         </div>
                      </div>
                   </div>
                </div>
