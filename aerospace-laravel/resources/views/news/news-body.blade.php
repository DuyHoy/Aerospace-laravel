            ...
            @foreach($posts as $post)
               <article itemscope="" itemtype="http://schema.org/ItemPage" class="mb-4 col-12">
                  <div class="card card-news flex-md-row">
                     <a title={{$post->title}} href="{{route('news', ['news' => $post->id])}}">
                     ...
                     <div class="card-body d-flex flex-column align-items-start">
                        <div class="card-text">
                           ...
                           <h4 class="h5 font-weight-bold"><a href="https://tjaerospace.com/news/happy-independence-day-from-the-tj-aerospace-team/">{{$post->title}}</a></h4>
                        </div>
